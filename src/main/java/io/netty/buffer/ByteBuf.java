 ...
 * complicated searches, use {@link #forEachByte(int, int, ByteBufProcessor)}
 * with a {@link ByteBufProcessor} implementation.
 *
 ...
 * {@link #duplicate()}, {@link #slice()} or {@link #slice(int, int)}. A derived
 * buffer will have an independent {@link #readerIndex() readerIndex},
 ...
 * <p>
 * Also be aware that obtaining derived buffers will NOT call {@link #retain()}
...
public abstract class ByteBuf implements Comparable<ByteBuf> {
	...
	public static ByteBuf allocate(int length, int maxLength) {
		return new ByteBufEaglercraftImpl(ByteBuffer.wrap(new byte[length]), maxLength);
	}

	public static ByteBuf allocate(ByteBuffer data, int maxLength) {
		return new ByteBufEaglercraftImpl(data, maxLength);
	}
	 ...
	 * the current capacity, the content of this buffer is truncated. If the
	 * {@code newCapacity} is greater than the current capacity, the buffer is
	 * appended with unspecified data whose length is
	 * {@code (newCapacity - currentCapacity)}.
	 */
	public abstract ByteBuf capacity(int newCapacity);

	/**
	 * Returns the maximum allowed capacity of this buffer. If a user attempts to
	 * increase the capacity of this buffer beyond the maximum capacity using
	 * {@link #capacity(int)} or {@link #ensureWritable(int)}, those methods will
	 ...
	 * indexes, or the marks of the returned buffer or this buffer affects each
	 * other's content, indexes, and marks. If the specified {@code endianness} is
	 * identical to this buffer's byte order, this method can return {@code this}.
	...
	/**
	 * Returns {@code true} if and only if this buffer is backed by an NIO direct
	 * buffer.
	 */
	 ...
	 * {@code 0}. This method is identical to {@link #setIndex(int, int) setIndex(0,
	 * 0)}.
	 * <p>
	 * Please note that the behavior of this method is different from that of NIO
	 * buffer, which sets the {@code limit} to the {@code capacity} of the buffer.
	 */
	...
	/**
	 * Makes sure the number of {@linkplain #writableBytes() the writable bytes} is
	 * equal to or greater than the specified value. If there is enough writable
	 * bytes in this buffer, this method returns with no side effect. Otherwise, it
	...
	/**
	 * Tries to make sure the number of {@linkplain #writableBytes() the writable
	 * bytes} is equal to or greater than the specified value. Unlike
	...
	/**
	 * Gets a boolean at the specified absolute (@code index) in this buffer. This
	 * method does not modify the {@code readerIndex} or {@code writerIndex} of this
	 * buffer.
	 *
	 * @throws IndexOutOfBoundsException if the specified {@code index} is less than
	 *                                   {@code 0} or {@code index + 1} is greater
	 *                                   than {@code this.capacity}
	 */
	 ...
	 * {@code index} in this buffer. This method does not modify {@code readerIndex}
	...
	/**
	 * Gets a 32-bit floating point number at the specified absolute {@code index}
	 * in this buffer. This method does not modify {@code readerIndex} or
	 * {@code writerIndex} of this buffer.
	 *
	 * @throws IndexOutOfBoundsException if the specified {@code index} is less than
	...
	/**
	 * Gets a 64-bit floating point number at the specified absolute {@code index}
	 * in this buffer. This method does not modify {@code readerIndex} or
	 * {@code writerIndex} of this buffer.
	 *
	 * @throws IndexOutOfBoundsException if the specified {@code index} is less than
	 ...
	 * specified absolute {@code index} until the destination becomes non-writable.
	 * This method is basically same with {@link #getBytes(int, ByteBuf, int, int)},
	 * except that this method increases the {@code writerIndex} of the destination
	 * by the number of the transferred bytes while
	 * {@link #getBytes(int, ByteBuf, int, int)} does not. This method does not
	 * modify {@code readerIndex} or {@code writerIndex} of the source buffer (i.e.
	 * {@code this}).
	 *
	 * @throws IndexOutOfBoundsException if the specified {@code index} is less than
	 *                                   {@code 0} or if
	 *                                   {@code index + dst.writableBytes} is
	 *                                   greater than {@code this.capacity}
	 */
	 ...
	 * {@link #getBytes(int, ByteBuf, int, int)}, except that this method increases
	 * the {@code writerIndex} of the destination by the number of the transferred
	 * bytes while {@link #getBytes(int, ByteBuf, int, int)} does not. This method
	 * does not modify {@code readerIndex} or {@code writerIndex} of the source
	 * buffer (i.e. {@code this}).
	 *
	 * @param length the number of bytes to transfer
	 *
	 * @throws IndexOutOfBoundsException if the specified {@code index} is less than
	 *                                   {@code 0}, if {@code index + length} is
	 *                                   greater than {@code this.capacity}, or if
	 ...
	 *
	 * @throws IndexOutOfBoundsException if the specified {@code index} is less than
	 *                                   {@code 0}, if the specified
	 *                                   {@code dstIndex} is less than {@code 0}, if
	 *                                   {@code index + length} is greater than
	 *                                   {@code this.capacity}, or if
	 *                                   {@code dstIndex + length} is greater than
	 *                                   {@code dst.capacity}
	 */
	 ...
	 *
	 * @throws IndexOutOfBoundsException if the specified {@code index} is less than
	 *                                   {@code 0} or if {@code index + dst.length}
	...
	/**
	 * Transfers this buffer's data to the specified destination starting at the
	 * specified absolute {@code index} until the destination's position reaches its
	 * limit. This method does not modify {@code readerIndex} or {@code writerIndex}
	 * of this buffer while the destination's {@code position} will be increased.
	 *
	 * @throws IndexOutOfBoundsException if the specified {@code index} is less than
	 *                                   {@code 0} or if
	 *                                   {@code index + dst.remaining()} is greater
	 *                                   than {@code this.capacity}
	 */
	 ...
	 *
	 * @throws IndexOutOfBoundsException if the specified {@code index} is less than
	 *                                   {@code 0} or if {@code index + length} is
	 *                                   greater than {@code this.capacity}
	 * @throws IOException               if the specified stream threw an exception
	 *                                   during I/O
	 */
	 ...
	 * {@code index} in this buffer. The 16 high-order bits of the specified value
	 * are ignored. This method does not modify {@code readerIndex} or
	 * {@code writerIndex} of this buffer.
	 *
	 * @throws IndexOutOfBoundsException if the specified {@code index} is less than
	 *                                   {@code 0} or {@code index + 2} is greater
	 ...
	 * {@code index} in this buffer. Please note that the most significant byte is
	 * ignored in the specified value. This method does not modify
	 * {@code readerIndex} or {@code writerIndex} of this buffer.
	 *
	 * @throws IndexOutOfBoundsException if the specified {@code index} is less than
	 *                                   {@code 0} or {@code index + 3} is greater
	...
	/**
	 * Sets the specified 32-bit integer at the specified absolute {@code index} in
	 * this buffer. This method does not modify {@code readerIndex} or
	 * {@code writerIndex} of this buffer.
	 *
	 * @throws IndexOutOfBoundsException if the specified {@code index} is less than
	...
	/**
	 * Transfers the specified source buffer's data to this buffer starting at the
	 * specified absolute {@code index} until the source buffer becomes unreadable.
	 * This method is basically same with {@link #setBytes(int, ByteBuf, int, int)},
	 * except that this method increases the {@code readerIndex} of the source
	 * buffer by the number of the transferred bytes while
	 * {@link #setBytes(int, ByteBuf, int, int)} does not. This method does not
	 * modify {@code readerIndex} or {@code writerIndex} of the source buffer (i.e.
	 * {@code this}).
	 *
	 * @throws IndexOutOfBoundsException if the specified {@code index} is less than
	 *                                   {@code 0} or if
	 *                                   {@code index + src.readableBytes} is
	 *                                   greater than {@code this.capacity}
	 */
	 ...
	 * Transfers the specified source buffer's data to this buffer starting at the
	 * specified absolute {@code index}. This method is basically same with
	 * {@link #setBytes(int, ByteBuf, int, int)}, except that this method increases
	 * the {@code readerIndex} of the source buffer by the number of the transferred
	 * bytes while {@link #setBytes(int, ByteBuf, int, int)} does not. This method
	 * does not modify {@code readerIndex} or {@code writerIndex} of the source
	 * buffer (i.e. {@code this}).
	 *
	 * @param length the number of bytes to transfer
	 ...
	 * @throws IndexOutOfBoundsException if the specified {@code index} is less than
	 *                                   {@code 0}, if the specified
	 *                                   {@code srcIndex} is less than {@code 0}, if
	 *                                   {@code index + length} is greater than
	 *                                   {@code this.capacity}, or if
	...
	/**
	 * Transfers the specified source array's data to this buffer starting at the
	 * specified absolute {@code index}. This method does not modify
	 * {@code readerIndex} or {@code writerIndex} of this buffer.
	 *
	 * @throws IndexOutOfBoundsException if the specified {@code index} is less than
	 *                                   {@code 0} or if {@code index + src.length}
	 *                                   is greater than {@code this.capacity}
	 */
	...
	/**
	 * Transfers the specified source buffer's data to this buffer starting at the
	 * specified absolute {@code index} until the source buffer's position reaches
	 * its limit. This method does not modify {@code readerIndex} or
	 * {@code writerIndex} of this buffer.
	 *
	 * @throws IndexOutOfBoundsException if the specified {@code index} is less than
	 *                                   {@code 0} or if
	 *                                   {@code index + src.remaining()} is greater
	 *                                   than {@code this.capacity}
	 */
	public abstract ByteBuf setBytes(int index, ByteBuffer src);

	/**
	 * Transfers the content of the specified source stream to this buffer starting
	 * at the specified absolute {@code index}. This method does not modify
	 * {@code readerIndex} or {@code writerIndex} of this buffer.
	 *
	 * @param length the number of bytes to transfer
	 *
	...
	/**
	 * Fills this buffer with <tt>NUL (0x00)</tt> starting at the specified absolute
	 ...
	 *
	 * @throws IndexOutOfBoundsException if {@code this.readableBytes} is less than
	 *                                   {@code 1}
	 */
	...
	/**
	 * Gets an unsigned byte at the current {@code readerIndex} and increases the
	 * {@code readerIndex} by {@code 1} in this buffer.
	 *
	 * @throws IndexOutOfBoundsException if {@code this.readableBytes} is less than
	 *                                   {@code 1}
	...
	/**
	 * Gets a 16-bit short integer at the current {@code readerIndex} and increases
	...
	/**
	 * Gets an unsigned 16-bit short integer at the current {@code readerIndex} and
	...
	/**
	 * Gets a 24-bit medium integer at the current {@code readerIndex} and increases
	 * the {@code readerIndex} by {@code 3} in this buffer.
	 *
	 * @throws IndexOutOfBoundsException if {@code this.readableBytes} is less than
	 *                                   {@code 3}
	 */
	...
	/**
	 * Gets an unsigned 24-bit medium integer at the current {@code readerIndex} and
	...
	/**
	 * Gets a 32-bit integer at the current {@code readerIndex} and increases the
	...
	/**
	 * Gets a 64-bit integer at the current {@code readerIndex} and increases the
	...
	/**
	 * Gets a 32-bit floating point number at the current {@code readerIndex} and
	 * increases the {@code readerIndex} by {@code 4} in this buffer.
	 *
	 * @throws IndexOutOfBoundsException if {@code this.readableBytes} is less than
	 *                                   {@code 4}
	...
	/**
	 * Gets a 64-bit floating point number at the current {@code readerIndex} and
	 ...
	 * {@code readerIndex} and {@code writerIndex} are {@code 0} and {@code length}
	 * respectively.
	 *
	 * @param length the number of bytes to transfer
	 *
	 ...
	 * {@code readerIndex} and increases the {@code readerIndex} by the size of the
	 * new slice (= {@code length}).
	 * <p>
	...
	/**
	 * Transfers this buffer's data to the specified destination starting at the
	 * current {@code readerIndex} until the destination becomes non-writable, and
	 * increases the {@code readerIndex} by the number of the transferred bytes.
	 * This method is basically same with {@link #readBytes(ByteBuf, int, int)},
	 * except that this method increases the {@code writerIndex} of the destination
	 * by the number of the transferred bytes while
	 ...
	 * Transfers this buffer's data to the specified destination starting at the
	 * current {@code readerIndex} and increases the {@code readerIndex} by the
	 * number of the transferred bytes (= {@code length}). This method is basically
	 * same with {@link #readBytes(ByteBuf, int, int)}, except that this method
	 * increases the {@code writerIndex} of the destination by the number of the
	 * transferred bytes (= {@code length}) while
	 * {@link #readBytes(ByteBuf, int, int)} does not.
	 *
	 * @throws IndexOutOfBoundsException if {@code length} is greater than
	 *                                   {@code this.readableBytes} or if
	 *                                   {@code length} is greater than
	 *                                   {@code dst.writableBytes}
	 */
	 ...
	 * @param length   the number of bytes to transfer
	 *
	 * @throws IndexOutOfBoundsException if the specified {@code dstIndex} is less
	 *                                   than {@code 0}, if {@code length} is
	 *                                   greater than {@code this.readableBytes}, or
	 ...
	 * limit, and increases the {@code readerIndex} by the number of the transferred
	 * bytes.
	 *
	...
	/**
	 * Sets the specified boolean at the current {@code writerIndex} and increases
	 * the {@code writerIndex} by {@code 1} in this buffer.
	 *
	 * @throws IndexOutOfBoundsException if {@code this.writableBytes} is less than
	 *                                   {@code 1}
	 */
	public abstract ByteBuf writeBoolean(boolean value);

	/**
	 * Sets the specified byte at the current {@code writerIndex} and increases the
	 * {@code writerIndex} by {@code 1} in this buffer. The 24 high-order bits of
	...
	/**
	 * Sets the specified 16-bit short integer at the current {@code writerIndex}
	 * and increases the {@code writerIndex} by {@code 2} in this buffer. The 16
	...
	/**
	 * Sets the specified 24-bit medium integer at the current {@code writerIndex}
	 * and increases the {@code writerIndex} by {@code 3} in this buffer.
	 *
	 * @throws IndexOutOfBoundsException if {@code this.writableBytes} is less than
	 *                                   {@code 3}
	 */
	...
	/**
	 * Sets the specified 64-bit long integer at the current {@code writerIndex} and
	...
	/**
	 * Sets the specified 2-byte UTF-16 character at the current {@code writerIndex}
	 * and increases the {@code writerIndex} by {@code 2} in this buffer. The 16
	 * high-order bits of the specified value are ignored.
	 *
	 * @throws IndexOutOfBoundsException if {@code this.writableBytes} is less than
	...
	/**
	 * Transfers the specified source buffer's data to this buffer starting at the
	 * current {@code writerIndex} until the source buffer becomes unreadable, and
	 * increases the {@code writerIndex} by the number of the transferred bytes.
	 * This method is basically same with {@link #writeBytes(ByteBuf, int, int)},
	 * except that this method increases the {@code readerIndex} of the source
	 * buffer by the number of the transferred bytes while
	...
	/**
	 * Transfers the specified source buffer's data to this buffer starting at the
	 * current {@code writerIndex} and increases the {@code writerIndex} by the
	 * number of the transferred bytes (= {@code length}). This method is basically
	 * same with {@link #writeBytes(ByteBuf, int, int)}, except that this method
	 * increases the {@code readerIndex} of the source buffer by the number of the
	 * transferred bytes (= {@code length}) while
	 * {@link #writeBytes(ByteBuf, int, int)} does not.
	 *
	 * @param length the number of bytes to transfer
	 *
	 * @throws IndexOutOfBoundsException if {@code length} is greater than
	 *                                   {@code this.writableBytes} or if
	 *                                   {@code length} is greater then
	 *                                   {@code src.readableBytes}
	 */
	 ...
	 * @param length   the number of bytes to transfer
	 *
	 * @throws IndexOutOfBoundsException if the specified {@code srcIndex} is less
	 *                                   than {@code 0}, if
	 *                                   {@code srcIndex + length} is greater than
	 *                                   {@code src.capacity}, or if {@code length}
	 ...
	 * Transfers the specified source array's data to this buffer starting at the
	 * current {@code writerIndex} and increases the {@code writerIndex} by the
	 * number of the transferred bytes (= {@code src.length}).
	 *
	 ...
	 *                                   than {@code 0}, if
	 *                                   {@code srcIndex + length} is greater than
	 *                                   {@code src.length}, or if {@code length} is
	...
	/**
	 * Transfers the specified source buffer's data to this buffer starting at the
	 * current {@code writerIndex} until the source buffer's position reaches its
	 * limit, and increases the {@code writerIndex} by the number of the transferred
	 * bytes.
	 *
	...
	/**
	 * Transfers the content of the specified stream to this buffer starting at the
	 * current {@code writerIndex} and increases the {@code writerIndex} by the
	 ...
	 * {@code writerIndex} and increases the {@code writerIndex} by the specified
	 * {@code length}.
	 *
	 * @param length the number of <tt>NUL</tt>s to write to the buffer
	 *
	...
	/**
	 * Locates the first occurrence of the specified {@code value} in this buffer.
	 * The search takes place from the current {@code readerIndex} (inclusive) to
	 * the current {@code writerIndex} (exclusive).
	 * <p>
	 * This method does not modify {@code readerIndex} or {@code writerIndex} of
	 * this buffer.
	 *
	 * @return the number of bytes between the current {@code readerIndex} and the
	...
	/**
	 * Locates the first occurrence of the specified {@code value} in this buffer.
	 * The search starts from the current {@code readerIndex} (inclusive) and lasts
	 * for the specified {@code length}.
	 * <p>
	 * This method does not modify {@code readerIndex} or {@code writerIndex} of
	 * this buffer.
	 *
	...
	/**
	 * Locates the first occurrence of the specified {@code value} in this buffer.
	 * The search starts from the specified {@code index} (inclusive) and lasts for
	 * the specified {@code length}.
	 * <p>
	 * This method does not modify {@code readerIndex} or {@code writerIndex} of
	 * this buffer.
	 *
	 * @return the number of bytes between the specified {@code index} and the first
	 *         occurrence if found. {@code -1} otherwise.
	 *
	 * @throws IndexOutOfBoundsException if {@code index + length} is greater than
	 *                                   {@code this.capacity}
	 */
	 ...
	 * returned buffer or this buffer does not affect each other at all. This method
	 * is identical to {@code buf.copy(buf.readerIndex(), buf.readableBytes())}.
	 * This method does not modify {@code readerIndex} or {@code writerIndex} of
	 * this buffer.
	 */
	...
	/**
	 * Returns a slice of this buffer's readable bytes. Modifying the content of the
	 * returned buffer or this buffer affects each other's content while they
	 * maintain separate indexes and marks. This method is identical to
	 * {@code buf.slice(buf.readerIndex(), buf.readableBytes())}. This method does
	 ...
	 *
	 * @return {@code -1} if this buffer has no underlying {@link ByteBuffer}. the
	 *         number of the underlying {@link ByteBuffer}s if this buffer has at
	 *         least one underlying {@link ByteBuffer}. Note that this method does
	 *         not return {@code 0} to avoid confusion.
	 *
	 * @see #nioBuffer()
	 ...
	 * returned buffer either share or contains the copied content of this buffer,
	 * while changing the position and limit of the returned NIO buffer does not
	 * affect the indexes and marks of this buffer. This method is identical to
	 * {@code buf.nioBuffer(buf.readerIndex(), buf.readableBytes())}. This method
	 * does not modify {@code readerIndex} or {@code writerIndex} of this buffer.
	...
	/**
	 * Exposes this buffer's sub-region as an NIO {@link ByteBuffer}. The returned
	 * buffer either share or contains the copied content of this buffer, while
	 * changing the position and limit of the returned NIO buffer does not affect
	 * the indexes and marks of this buffer. This method does not modify
	 * {@code readerIndex} or {@code writerIndex} of this buffer. Please note that
	 * the returned NIO buffer will not see the changes of this buffer if this
	 * buffer is a dynamic buffer and it adjusted its capacity.
	 *
	 * @throws UnsupportedOperationException if this buffer cannot create a
	 *                                       {@link ByteBuffer} that shares the
	 *                                       content with itself
	 ...
	 * returned buffer either share or contains the copied content of this buffer,
	 * while changing the position and limit of the returned NIO buffer does not
	 * affect the indexes and marks of this buffer. This method does not modify
	 * {@code readerIndex} or {@code writerIndex} of this buffer. Please note that
	 * the returned NIO buffer will not see the changes of this buffer if this
	 * buffer is a dynamic buffer and it adjusted its capacity.
	 *
	 ...
	 * index and length The returned buffer either share or contains the copied
	 * content of this buffer, while changing the position and limit of the returned
	 * NIO buffer does not affect the indexes and marks of this buffer. This method
	 * does not modify {@code readerIndex} or {@code writerIndex} of this buffer.
	 * Please note that the returned NIO buffer will not see the changes of this
	 * buffer if this buffer is a dynamic buffer and it adjusted its capacity.
	 *
	...
	/**
	 * Returns {@code true} if and only if this buffer has a backing byte array. If
	 * this method returns true, you can safely call {@link #array()} and
	 * {@link #arrayOffset()}.
	 */
	...
	/**
	 * Returns the offset of the first byte within the backing byte array of this
	 * buffer.
	 *
	 * @throws UnsupportedOperationException if there no accessible backing byte
	 *                                       array
	 ...
	 * this buffer.
	 *
	 * @throws UnsupportedCharsetException if the specified character set name is
	 *                                     not supported by the current VM
	 */
	public abstract String toString(Charset charset);

	/**
	 * Decodes this buffer's sub-region into a string with the specified character
	 * set. This method does not modify {@code readerIndex} or {@code writerIndex}
	 * of this buffer.
	 */
	public abstract String toString(int index, int length, Charset charset);

	/**
	 * Returns a hash code which was calculated from the content of this buffer. If
	 * there's a byte array which is {@linkplain #equals(Object) equal to} this
	 * array, both arrays should return the same value.
	 */
	@Override
	public abstract int hashCode();

	/**
	 * Determines if the content of the specified buffer is identical to the content
	 ...
	 * Comparison is performed in the same manner with the string comparison
	 * functions of various languages such as {@code strcmp}, {@code memcmp} and
	 ...
	 * necessarily return the whole content of the buffer but returns the values of
	 * the key properties such as {@link #readerIndex()}, {@link #writerIndex()} and
	 * {@link #capacity()}.
	 */
	@Override
